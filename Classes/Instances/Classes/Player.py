...
class Player:
    ...
    NotificationFactory = {
        1: {'ID': 94, 'Index': 0, 'Read': False, 'Time': datetime.datetime.timestamp(datetime.datetime.now()), 'Message': 'Voucher redeemed', 'ResourceCount': 1, 'ResourceID': 0, 'BrawlerID': 0, 'SkinID': 159}
    }
