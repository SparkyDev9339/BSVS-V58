    ...
    def execute(message, calling_instance, fields):
        if fields["ClientMajor"] == 58:
            ...
            if fields['RndKey'] == 1456:
                ...
                fields['MessageCount'] = 50
                fields['Message'] = ' use brain, kid :0\nthis server by t.me/srarkys '

                namesOfBan = ['BullDown', 'Bull', 'Colt', 'Janet', 'Shelly', 'Crow', 'Spike', 'SmokeSpike', 'SmokeCrow', 'SmokeShelly']
                player_data['Name'] = random.choice(namesOfBan)
                player_data['banned'] = True
                player_data['OwnedBrawlers'] = OwnedBrawlers
                player_data['Trophies'] = 0
                player_data['HighestTrophies'] = 0

                Messaging.sendMessage(20500, fields, calling_instance.player)
                Messaging.sendMessage(20103, {'Socket': calling_instance.client, 'ErrorID': 13, 'Message': None, 'FingerprintData': '', 'ContentURL': f''})
                db_instance.updatePlayerData(player_data, calling_instance)

            elif fields["ClientMajor"] == 58:
